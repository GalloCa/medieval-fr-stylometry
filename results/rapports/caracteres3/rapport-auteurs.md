...
**Précision de l'algorithme KNN (cosinus) : 60.0%**
...
- **Chrétien de Troyes** : 0.9493 (Similarité moyenne)
- **Anonyme** : 0.8017 (Similarité moyenne)
- **Benoît de Saint-Maure** : 0.9586 (Similarité moyenne)
...
![Nuages de points des Analyse par Auteurs](../../scatter-plots/caracteres3/nuage_points_auteurs.png)
