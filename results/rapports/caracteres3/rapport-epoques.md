...
- **XIIe siècle** : 0.8551 (Similarité moyenne)
- **XIe siècle** : *Non calculable (1 seul texte)*
- **XIIIe siècle** : 0.8335 (Similarité moyenne)
- **XIVe siècle** : 0.8763 (Similarité moyenne)
...
![Nuages de points des Analyse par Époques](../../scatter-plots/caracteres3/nuage_points_dates.png)
