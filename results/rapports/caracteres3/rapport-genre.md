...
**Précision de l'algorithme KNN (cosinus) : 52.0%**
...
- **Roman courtois** : 0.8909 (Similarité moyenne)
- **Hagiographie** : 0.8364 (Similarité moyenne)
- **Antique** : *Non calculable (1 seul texte)*
- **Prose** : 0.8432 (Similarité moyenne)
- **Didactique** : 0.8159 (Similarité moyenne)
...
![Nuages de points des Analyse par Genres Littéraires](../../scatter-plots/caracteres3/nuage_points_genre.png)
